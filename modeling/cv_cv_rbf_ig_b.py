#
#   Module: cv_cv_rbf_ig_b.py
#	Author: Jie Shen  @ NCTR/FDA
#	Date: Sep. 12, 2012.
#
#   Description:
#       This update uses the "dynamic" bins, the width of the bin equals 1, which means the gene expression with 2 fold
#       change will be considered as difference .
##############################
